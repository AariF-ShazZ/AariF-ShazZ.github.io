        ...
        <Flex display={["none" , "none" , "none" ,"flex" ,"flex"]} w="30%" justifyContent={"center"} alignItems="center" bg="">
          <Box > 
            <a href="">
              ...
              <Text fontSize={"25px"} color="gray">+91 9717971424</Text>
            ...
            <a href="">
              ...
              <Text fontSize={"25px"} color="gray">aarif568khan@gmail.com</Text>
             
              </Box>
            </a>
            <a href="hhttps://github.com/AariF-ShazZ">
              <Box display={"flex"} alignItems="center"  marginBottom={"10%"}   justifyContent={"space-between"} bg=""> 
              <img  width="50px"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYiBwe7URF5iyjMW20qp4IvMNvys8-tGb_-A&usqp=CAU" alt="" /><Text fontSize={"25px"} color="gray">AariF - ShazZ</Text>
              </Box>
            </a>
            <a href="https://www.linkedin.com/in/aarif-shazz-638647208/" fontSize="50px">
              <Box display={"flex"} alignItems="center"  marginBottom={"15%"}  justifyContent={"space-between"} bg=""> 
              <img  width="50px"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2RYeN56EvozwyyxYGDw4dTu-pbUZyNxnF93zSLUcOlQ&s" alt="" /><Text fontSize={"25px"} color="gray">AariF - ShazZ</Text>
              </Box>
            </a>
